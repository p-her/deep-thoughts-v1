  ...
  return (
    <main>
      <div className="flex-row justify-space-between">
        ...
        {/*  Now if the value of loggedIn is true and there is data in the userData variable 
            we created from the useQuery() Hook, we'll render a righthand column <div> that holds 
            our <FriendList> component!*/}
        {loggedIn && userData ? (
